...
function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 p-4 flex flex-col">
      {/* Logo */}
      <div className="flex items-center gap-2 px-3 py-4 mb-6">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center">
          <Briefcase className="w-4 h-4 text-white" />
        </div>
        <span className="text-lg font-semibold text-gray-900 dark:text-white">GigSchool</span>
      </div>
      ...
      <div className="border-t border-gray-100 dark:border-gray-800 pt-4 mt-4">
        ...
        <button
          onClick={() => signOut()}
          className="w-full mt-2 flex items-center gap-2 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
        >
  ...
  return (
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-950">
      ...
      <main className="flex-1 overflow-auto">
        <header className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-8 py-4">
